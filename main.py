...
[+] nmap-heartbleed-scan           ssl-heartbleed.nse
         ...
         ip_port_scan = input("[+] set target ip: ")
         ...
         ip_service_scan = input("[+] set target ip: ")
         ...
         ip_op_scan = input("[+] set target ip: ")
         ...
         ip_open_only = input("[+] set target ip: ")
         ...
         console.log("[bold yellow][!][/bold yellow] [blue]scanning "+dns+" dnsbrute scan[/blue]")
         verbose = input("[!] do you want to add -v for verbose[y/n]: ")
         if verbose == "y":
